...
import com.marianogili.traceeditor.diagram.part.TraceEditorDiagramActionBarContributor;
import com.marianogili.traceeditor.diagram.part.TraceEditorDiagramEditor;

public class TraceeditorMultipageActionBarContributor extends
	...
	private IPropertyListener myEditorPropertyChangeListener = new IPropertyListener() {
		...
		public void propertyChanged(Object source, int propId) {
			if (myActiveEditorActionBars != null) {
				if (myActiveEditorActionBars.getContributor() instanceof TraceeditorActionBarContributor) {
					((TraceeditorActionBarContributor) myActiveEditorActionBars.getContributor()).update();
				}
			}
		}
	};
	...
	public void setActivePage(IEditorPart activeEditor) {
		if (activeEditor instanceof TraceEditorDiagramEditor) {
	...
	public SubActionBarsExt getTreeSubActionBars() {
		if (myTreeSubActionBars == null) {
			myTreeSubActionBars = new SubActionBarsExt(getPage(),
					myActionBars2, new TraceeditorActionBarContributor(),
	...
	public SubActionBarsExt getDiagramSubActionBars() {
		if (myDiagramSubActionBars == null) {
			myDiagramSubActionBars = new SubActionBarsExt(getPage(),
					myActionBars2,
					new TraceEditorDiagramActionBarContributor(),
