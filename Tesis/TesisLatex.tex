...
Ecore es el modelo usado para representar modelos en EMF. Ecore es en sí mismo un modelo EMF, por lo cual es su propio meta-modelo. Un modelo simplificado de Ecore se puede observar en la imagen \ref{fig:EcoreModel}.
