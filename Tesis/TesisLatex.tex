...
%\begin{figure}[hbtp]
%\centering
%\includegraphics[scale=.65]{./img/GMFArquitectura}
...
\item Create a domain model, this model defines the non-graphical information managed by the editor

\item    Create a diagram definition model, this model defines graphical elements to be displayed in the editor

\item    Create a diagram mapping model, this model defines mapping between domain model elements and graphical elements

\item    Generate the graphical editor

\item    Enhance the graphical editor by editing the generated plug-in code
