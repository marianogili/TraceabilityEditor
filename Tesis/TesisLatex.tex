...
Este meta-modelo toma los \textit{tracelinks} de la entrada y la salida de una única transformación. El meta-modelo está basado en el \textit{meta-modelo de tracelinks} presentado en \cite{Jouault} y se muestra en el dibujo \ref{fig:LocalTraceMetamodel}.
