...
\item Que la adaptación de una herramienta cualquiera, que quiera agregar la funcionalidad de traceability que hace uso de este esquema, sea una tarea sencilla.

\item Aún dada la infinidad de artefactos que se pueden presentar, que el esquema siempre permita ofrecer la información semántica de los mismos, con el fin de facilitar la validación de enlaces legítimos.

\item Posibilidad de identificar unívocamente cada artefacto que se desee tracear.

\end{itemize}

El esquema propuesto se puede observar en el dibujo \ref{fig:EsquenaPropuesto}
