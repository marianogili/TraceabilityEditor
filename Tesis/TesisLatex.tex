...
%\subsection{Uso de traceability}
%Según \cite{DSIS}, de acuerdo a las siguientes fases del desarrollo presenta ejemplos de cómo ayuda el uso de la información de \textit{traceability} en cada una:
%
%\begin{itemize}
%
%\item \textbf{\textit{Planeamiento}}: Un ejemplo son las decisiones sobre el desarrollo del sistema que serán utilizadas como fundamento en las fases siguientes. Una decisión o acuerdo estarán relacionadas con su origen, por ejemplo, una reunión específica o una solicitud de un interesado.
%
%\item \textbf{\textit{Diseño}}: Un arquitecto puede relacionar una especificación de un componente de software funcional con un requerimiento, denotando la dependencia que existe, mediante una relación de \textsf{implementa} o \textsf{satisface}.
%
%\item \textbf{\textit{Implementación}}: con las transformaciones de modelos se capturan las relaciones entre los artefactos origen y destinos.
%
%\item \textbf{\textit{Prueba/despliegue}}: La información de \textit{traceability} se puede usar para chequear que todos los requerimientos fueron \textsf{satisfechos} por uno o más artefactos en el sistema, un análisis de cobertura de requerimientos.
%
%\item \textbf{\textit{Mantenimiento}}: Un ingeniero puede usar la información de \textit{traceability} para identificar errores en el caso de que un componente de software falla o no funciona de acuerdo a su especificación.
%
%\item \textbf{\textit{Actualización/cambio}}: Si es necesaria una nueva funcionalidad/característica o un cambio, un análisis de impactos será excelente gracias a la información de \textit{traceability}.
%
%\end{itemize}
...
\subsubsection{Transformación QvtoTrace{\_}To{\_}Trace}
...
\subsubsection{Editor gráfico y tabular TraceEditor}
