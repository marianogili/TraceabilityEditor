...
\item Mejorar el \textit{esquema de traceability} propuesto para ofrecer además la funcionalidad de versionado, los métodos de detección e información de errores y la organización de los \textit{tracelinks} según ejecución de cadenas de transformación.

\item Definir e implementar una solución para que la herramienta también trabaje sobre transformaciones \gls{atl}, tomando como referencia los ejemplos vistos antes en \ref{cap:ATLTtraceability}.
