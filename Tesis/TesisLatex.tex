...
En principio quiero agradecer a mis padres, \textbf{Ana María Bloga} y \textbf{Nestor Hugo Gili}, quienes nunca dudaron en brindarme el soporte necesario para afrontar esta carrera de grado. A mi mujer \textbf{María Jimena Reimundo}, por su incansable apoyo en estos últimos años que necesité para poder terminar la tesis al mismo tiempo que empezamos a contruir nuestro hermosa familia y hogar.

A la \textbf{Universidad Nacional de La Plata} y en particular a la \textbf{Facultad de Informática}, por la excelente formación que considero he obtenido, por haberme permitido por un tiempo disfrutar de la gratificante tarea de ser ayudante de cátedra y también por haberme brindado la posibilidad de realizar trabajos de investigación en distintos temas que me apasionaron.

A la profesora \textbf{Claudia Pons} por la excelente predisposición que recibí en cada consulta que le hice y su ayuda constante, en especial y sobre todo, por haberme introducido en el grupo de investigación del tema \textbf{Desarrollo Dirigido por Modelos} y su guía en la definición del tema de la presente tesis \textbf{Traceability}.
