...
\newglossaryentry{mde}{
	name={Ingeniería de Software Dirigida por Modelos},
...
\newglossaryentry{mda}{
	name={Arquitectura Dirigida por Modelos}, 
	description={en inglés Model-Driven Architecture (MDA), es una visión o propuesta particular definida por el \gls{omg} de \gls{mdd} que se basa en el uso de estándares de OMG.}
}

\newglossaryentry{omg}{
	name={Object Management Group}, 
	description={Consorcio internacional de la industrial informática sin fines de lucro y de membresía abierta responsable de la definición de varios estándares de modelado como \gls{uml}, \gls{mof} y \gls{mda}.}
}
