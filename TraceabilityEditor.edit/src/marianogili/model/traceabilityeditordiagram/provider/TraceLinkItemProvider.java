...
/**
 * This is the item provider adapter for a {@link marianogili.model.traceabilityeditordiagram.TraceLink} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TraceabilityeditordiagramPackage.Literals.TRACE_LINK__SOURCES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTargetsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TraceLink_targets_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TraceLink_targets_feature", "_UI_TraceLink_type"),
				 TraceabilityeditordiagramPackage.Literals.TRACE_LINK__TARGETS,
				 true,
				 false,
				 true,
				 null,
