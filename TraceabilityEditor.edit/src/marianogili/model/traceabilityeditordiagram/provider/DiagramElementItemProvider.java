...
/**
 * This is the item provider adapter for a {@link marianogili.model.traceabilityeditordiagram.DiagramElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DiagramElementItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DiagramElement_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DiagramElement_name_feature", "_UI_DiagramElement_type"),
				 TraceabilityeditordiagramPackage.Literals.DIAGRAM_ELEMENT__NAME,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DiagramElement.class)) {
			case TraceabilityeditordiagramPackage.DIAGRAM_ELEMENT__NAME:
