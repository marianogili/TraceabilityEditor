 ...
 * @generated
 */
public abstract class TraceEditorAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = TraceEditorDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected TraceEditorAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
