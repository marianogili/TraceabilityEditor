package com.marianogili.traceeditor.diagram.parsers;
 ...
 * @generated
 */
public class TraceLinkLabelExpressionLabelParser extends
		ExpressionLabelParserBase {
	/**
	 * @generated
	 */
	public TraceLinkLabelExpressionLabelParser() {
	}
	...
	protected String getExpressionBody() {
		return TraceEditorOCLFactory.getExpression(1,
				TraceeditorPackage.eINSTANCE.getTraceLink(), null).body();
	}
