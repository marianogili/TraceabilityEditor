 ...
 * @generated
 */
public class ArtefactLabelExpressionLabelParser extends
		ExpressionLabelParserBase {
	/**
	 * @generated
	 */
	public ArtefactLabelExpressionLabelParser() {
	}
	...
	protected String getExpressionBody() {
		return TraceEditorOCLFactory.getExpression(2,
				TraceeditorPackage.eINSTANCE.getArtefact(), null).body();
	}
