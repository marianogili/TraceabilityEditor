...
public class Artefact2EditPart extends ShapeNodeEditPart {
	...
	protected NodeFigure createNodePlate() {
		DefaultSizeNodeFigure result = new DefaultSizeNodeFigure(180, 110) {
			public PointList getPolygonPoints() {
				...
				points.addPoint(anchRect.x + anchRect.width - 30, anchRect.y + 10); // A2
				points.addPoint(anchRect.x + anchRect.width - 30, anchRect.y + anchRect.height - 10); // A3
				points.addPoint(anchRect.x + 30, anchRect.y + anchRect.height - 10); // A4
				points.addPoint(anchRect.x + 30, anchRect.y + 10); // A1
				return points;
			}
		};
	...
	public class TargetArtefactFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			targetArtefactFigureInt0.setForegroundColor(ColorConstants.black);
			targetArtefactFigureInt0.setBackgroundColor(ColorConstants.cyan);
