...
public class TransformationTransformationCompartmentCanonicalEditPolicy extends
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return TraceeditorPackage.eINSTANCE.getTransformation_TraceLinks();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<TraceEditorNodeDescriptor> childDescriptors = TraceEditorDiagramUpdater
				.getTransformationTransformationCompartment_7004SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return TraceLink2EditPart.VISUAL_ID == TraceEditorVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<TraceEditorNodeDescriptor> childDescriptors = TraceEditorDiagramUpdater
				.getTransformationTransformationCompartment_7004SemanticChildren((View) getHost()
						.getModel());
