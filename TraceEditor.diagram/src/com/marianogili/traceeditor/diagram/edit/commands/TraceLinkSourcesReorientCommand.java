 ...
 * @generated
 */
public class TraceLinkSourcesReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public TraceLinkSourcesReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return TraceEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistTraceLinkSources_4001(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return TraceEditorBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistTraceLinkSources_4001(getOldSource(), getNewTarget());
	}
