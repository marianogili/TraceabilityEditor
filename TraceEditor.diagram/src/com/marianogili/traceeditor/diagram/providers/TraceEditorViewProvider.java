 ...
 * @generated
 */
public class TraceEditorViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return TraceEditorEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = TraceEditorVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				if (!TraceEditorElementTypes.isKnownElementType(elementType)
				...
				if (!TraceEditorEditPart.MODEL_ID
						.equals(TraceEditorVisualIDRegistry.getModelID(op
								.getContainerView()))) {
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = TraceEditorVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != TraceEditorVisualIDRegistry
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(TraceEditorEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			...
			visualID = TraceEditorVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case DashboardEditPart.VISUAL_ID:
			return createDashboard_2001(domainElement, containerView, index,
	 ...
	 * @generated
	 */
	public Node createDashboard_2001(EObject domainElement, View containerView,
	...
	private void stampShortcut(View containerView, Node target) {
		if (!TraceEditorEditPart.MODEL_ID.equals(TraceEditorVisualIDRegistry
			...
			shortcutAnnotation.getDetails().put(
					"modelID", TraceEditorEditPart.MODEL_ID); //$NON-NLS-1$
