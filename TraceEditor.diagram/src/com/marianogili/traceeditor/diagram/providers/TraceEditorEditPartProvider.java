...
import com.marianogili.traceeditor.diagram.edit.parts.TraceEditorEditPartFactory;
import com.marianogili.traceeditor.diagram.part.TraceEditorVisualIDRegistry;

/**
 * @generated
 */
public class TraceEditorEditPartProvider extends AbstractEditPartProvider {
	 ...
	 * @generated
	 */
	public TraceEditorEditPartProvider() {
		setFactory(new TraceEditorEditPartFactory());
	...
	public synchronized boolean provides(IOperation operation) {
		if (operation instanceof CreateGraphicEditPartOperation) {
			...
			if (!TraceEditorEditPart.MODEL_ID
					.equals(TraceEditorVisualIDRegistry.getModelID(view))) {
				return false;
			}
