 ...
 * @generated
 */
public class TraceEditorInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new TraceEditorNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				TraceEditorEditPart.MODEL_ID));
		TraceEditorDiagramEditorUtil.runWizard(getShell(), wizard,
