 ...
 * @generated
 */
public class TraceEditorCreationWizard extends Wizard implements INewWizard {
	 ...
	 * @generated
	 */
	protected TraceEditorCreationWizardPage diagramModelFilePage;
	...
	public void init(IWorkbench workbench, IStructuredSelection selection) {
		...
		setWindowTitle(Messages.TraceEditorCreationWizardTitle);
		setDefaultPageImageDescriptor(TraceEditorDiagramEditorPlugin
				.getBundledImageDescriptor("icons/wizban/NewTraceeditorWizard.gif")); //$NON-NLS-1$
					...
					try {
						...
						ErrorDialog
								.openError(
										...
										Messages.TraceEditorCreationWizardOpenEditorError,
										null, e.getStatus());
					}
				}
			}
		...
		try {
			...
			if (e.getTargetException() instanceof CoreException) {
				ErrorDialog.openError(getContainer().getShell(),
						Messages.TraceEditorCreationWizardCreationError, null,
