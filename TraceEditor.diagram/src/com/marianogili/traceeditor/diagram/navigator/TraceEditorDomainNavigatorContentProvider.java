 ...
 * @generated
 */
public class TraceEditorDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public TraceEditorDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof TraceEditorDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((TraceEditorDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new TraceEditorDomainNavigatorItem(
