...
import marianogili.model.traceabilityeditordiagram.diagram.part.TraceabilityEditorDiagramDiagramEditor;
 ...
 * @generated
 */
public class TraceabilityEditorDiagramNavigatorActionProvider extends
	...
	private class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof TraceabilityEditorDiagramNavigatorItem) {
					selectedElement = ((TraceabilityEditorDiagramNavigatorItem) selectedElement)
							.getView();
