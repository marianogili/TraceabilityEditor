 ...
 * @generated
 */
public class TraceabilityEditorDiagramNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public TraceabilityEditorDiagramNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		if (parentElement instanceof IFile) {
			...
			result.addAll(createNavigatorItems(selectViewsByType(resource
					.getContents(), DibujoEditPart.MODEL_ID), file, false));
			return result.toArray();
		}

		if (parentElement instanceof TraceabilityEditorDiagramNavigatorGroup) {
			TraceabilityEditorDiagramNavigatorGroup group = (TraceabilityEditorDiagramNavigatorGroup) parentElement;
			return group.getChildren();
		}

		if (parentElement instanceof TraceabilityEditorDiagramNavigatorItem) {
			TraceabilityEditorDiagramNavigatorItem navigatorItem = (TraceabilityEditorDiagramNavigatorItem) parentElement;
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case DibujoEditPart.VISUAL_ID: {
			...
			Collection connectedViews = getChildrenByType(Collections
					.singleton(view), TraceabilityEditorDiagramVisualIDRegistry
					.getType(TraceabilityEditorDiagramEditPart.VISUAL_ID));
	...
	private Collection createNavigatorItems(Collection views, Object parent,
		...
		Collection result = new ArrayList();
		for (Iterator it = views.iterator(); it.hasNext();) {
			result.add(new TraceabilityEditorDiagramNavigatorItem((View) it
					.next(), parent, isLeafs));
		}
		return result;
	}
	...
	public Object getParent(Object element) {
		if (element instanceof TraceabilityEditorDiagramAbstractNavigatorItem) {
			TraceabilityEditorDiagramAbstractNavigatorItem abstractNavigatorItem = (TraceabilityEditorDiagramAbstractNavigatorItem) element;
