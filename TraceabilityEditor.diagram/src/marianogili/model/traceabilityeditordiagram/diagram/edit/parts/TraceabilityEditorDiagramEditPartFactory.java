 ...
 * @generated
 */
public class TraceabilityEditorDiagramEditPartFactory implements
		EditPartFactory {
	...
	public EditPart createEditPart(EditPart context, Object model) {
		if (model instanceof View) {
			...
			case DibujoEditPart.VISUAL_ID:
				return new DibujoEditPart(view);

			case TraceabilityEditorDiagramEditPart.VISUAL_ID:
				return new TraceabilityEditorDiagramEditPart(view);
			...
			case TraceabilityEditorDiagramTEDCompartmentLeftEditPart.VISUAL_ID:
				return new TraceabilityEditorDiagramTEDCompartmentLeftEditPart(
						view);

			case TraceabilityEditorDiagramTEDCompartmentCenterEditPart.VISUAL_ID:
				return new TraceabilityEditorDiagramTEDCompartmentCenterEditPart(
						view);

			case TraceabilityEditorDiagramTEDCompartmentRightEditPart.VISUAL_ID:
				return new TraceabilityEditorDiagramTEDCompartmentRightEditPart(
						view);
			}
		}
