 ...
 * @generated
 */
public class TraceabilityEditorDiagramItemSemanticEditPolicy extends
		TraceabilityEditorDiagramBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public TraceabilityEditorDiagramItemSemanticEditPolicy() {
		super(
	...
	private void addDestroyChildNodesCommand(ICompositeCommand cmd) {
		...
		for (Iterator nit = view.getChildren().iterator(); nit.hasNext();) {
			...
			switch (TraceabilityEditorDiagramVisualIDRegistry.getVisualID(node)) {
