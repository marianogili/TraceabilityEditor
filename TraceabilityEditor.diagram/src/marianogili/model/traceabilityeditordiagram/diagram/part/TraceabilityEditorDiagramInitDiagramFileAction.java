 ...
 * @generated
 */
public class TraceabilityEditorDiagramInitDiagramFileAction implements
	...
	public void run(IAction action) {
		...
		Wizard wizard = new TraceabilityEditorDiagramNewDiagramFileWizard(
				domainModelURI, diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				DibujoEditPart.MODEL_ID));
		TraceabilityEditorDiagramDiagramEditorUtil.runWizard(getShell(),
