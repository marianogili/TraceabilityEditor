 ...
 * @generated
 */
public class TraceabilityEditorDiagramViewProvider extends AbstractProvider
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return DibujoEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = TraceabilityEditorDiagramVisualIDRegistry
					.getNodeVisualID(op.getContainerView(), domainElement);
		} else {
			visualID = TraceabilityEditorDiagramVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				if (!TraceabilityEditorDiagramElementTypes
		...
		return TraceabilityEditorDiagramEditPart.VISUAL_ID == visualID
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(DibujoEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		switch (visualID) {
		case TraceabilityEditorDiagramEditPart.VISUAL_ID:
			return createTraceabilityEditorDiagram_2001(domainElement,
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (TraceabilityEditorDiagramVisualIDRegistry
				.getVisualID(elementTypeHint)) {
		}
	 ...
	 * @generated
	 */
	public Node createTraceabilityEditorDiagram_2001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(TraceabilityEditorDiagramVisualIDRegistry
	...
	private void stampShortcut(View containerView, Node target) {
		if (!DibujoEditPart.MODEL_ID
			...
			shortcutAnnotation.getDetails().put(
					"modelID", DibujoEditPart.MODEL_ID); //$NON-NLS-1$
