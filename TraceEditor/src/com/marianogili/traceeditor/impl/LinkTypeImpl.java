...
public class LinkTypeImpl extends NamedElementImpl implements LinkType {
	...
	protected EClass eStaticClass() {
		return TraceeditorPackage.Literals.LINK_TYPE;
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TraceeditorPackage.LINK_TYPE__DESCRIPTION, oldDescription, description));
	}
