 ...
 * @generated
 */
public class TraceeditorSwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TraceeditorPackage.NAMED_ELEMENT: {
				NamedElement namedElement = (NamedElement)theEObject;
				T result = caseNamedElement(namedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TraceeditorPackage.TRANSFORMATION: {
			...
			case TraceeditorPackage.TRACE_LINK: {
				TraceLink traceLink = (TraceLink)theEObject;
				T result = caseTraceLink(traceLink);
				if (result == null) result = caseNamedElement(traceLink);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TraceeditorPackage.ARTEFACT: {
				Artefact artefact = (Artefact)theEObject;
				T result = caseArtefact(artefact);
				if (result == null) result = caseNamedElement(artefact);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TraceeditorPackage.DASHBOARD: {
				Dashboard dashboard = (Dashboard)theEObject;
				T result = caseDashboard(dashboard);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TraceeditorPackage.TRACE_EDITOR: {
				TraceEditor traceEditor = (TraceEditor)theEObject;
				T result = caseTraceEditor(traceEditor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TraceeditorPackage.TYPE_ARTEFACT: {
				TypeArtefact typeArtefact = (TypeArtefact)theEObject;
				T result = caseTypeArtefact(typeArtefact);
				if (result == null) result = caseNamedElement(typeArtefact);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TraceeditorPackage.LINK_TYPE: {
			...
			case TraceeditorPackage.CONFIGURATION: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Trace Editor</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Trace Editor</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTraceEditor(TraceEditor object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Type Artefact</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Type Artefact</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTypeArtefact(TypeArtefact object) {
		return null;
	}
